...
employment <- tribble(
  ...
  "Technical Officer", "ASEAN Biological Threats Surveillance Centre", "Jakarta, Indonesia", "2023-present", list("Responsible for developing surveillance data standards for ASEAN region", 
  ...
  "Researcher", "Center for Tropical Medicine, Universitas Gadjah Mada", "Yogyakarta, Indonesia", "2020-present", list("Epidemic intelligence", "Infectious disease transmission dynamics"),
