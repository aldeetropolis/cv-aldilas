...
address: "Center for Tropical Medicine, Universitas Gadjah Mada | ASEAN Biodiaspora Virtual Center"
...
employment <- tribble(
  ...
  "Technical Officer", "ASEAN Biological Threats Surveillance Centre", "Jakarta, Indonesia", "2023-present",
    list("Responsible for developing surveillance data standards for ASEAN region", 
  ...
  "Research Assistant", "International Center for Health Information Technology, Taipei Medical University", "Taipei, ROC Taiwan", "2018-2019", list("Assist in developing predictive modelling especially in chronic diseases such as cancer and chronic kidney diseases"),
